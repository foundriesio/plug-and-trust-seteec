...
HEADER_FILE = os.path.abspath(os.path.dirname(__file__)) + os.sep + ".." + os.sep + "ex" + os.sep + "inc" + os.sep + "ex_sss_tp_scp03_keys.h"

KEYS_SSS_PFSCP_ENABLE_SE050A1 = (
...
KEYS_SSS_PFSCP_ENABLE_SE050_DEVKIT = (
...
KEYS_SSS_PFSCP_ENABLE_SE051C_0005A8FA = (
...
KEYS_SSS_PFSCP_ENABLE_SE051A_0001A920 = (
...
KEYS_SSS_PFSCP_ENABLE_SE050E_0001A921 = (
...
KEYS_SSS_PFSCP_ENABLE_SE051W_0005A739 = (
...
KEYS_SSS_PFSCP_ENABLE_A5000_0004A736 = (
...
KEYS_SSS_PFSCP_ENABLE_SE050F2_0001A92A = (
...
LIST_ALL_OEFS = (
    # (Keys List, Macro)
    (KEYS_SSS_PFSCP_ENABLE_SE050A1, "SSS_PFSCP_ENABLE_SE050A1"),
    (KEYS_SSS_PFSCP_ENABLE_SE050A2, "SSS_PFSCP_ENABLE_SE050A2"),
    (KEYS_SSS_PFSCP_ENABLE_SE050B1, "SSS_PFSCP_ENABLE_SE050B1"),
    (KEYS_SSS_PFSCP_ENABLE_SE050B2, "SSS_PFSCP_ENABLE_SE050B2"),
    (KEYS_SSS_PFSCP_ENABLE_SE050C1, "SSS_PFSCP_ENABLE_SE050C1"),
    (KEYS_SSS_PFSCP_ENABLE_SE050C2, "SSS_PFSCP_ENABLE_SE050C2"),
    (KEYS_SSS_PFSCP_ENABLE_SE050_DEVKIT, "SSS_PFSCP_ENABLE_SE050_DEVKIT"),
    (KEYS_SSS_PFSCP_ENABLE_SE051A2, "SSS_PFSCP_ENABLE_SE051A2"),
    (KEYS_SSS_PFSCP_ENABLE_SE051C2, "SSS_PFSCP_ENABLE_SE051C2"),
    (KEYS_SSS_PFSCP_ENABLE_SE050F2, "SSS_PFSCP_ENABLE_SE050F2"),
    (KEYS_SSS_PFSCP_ENABLE_SE051C_0005A8FA, "SSS_PFSCP_ENABLE_SE051C_0005A8FA"),
    (KEYS_SSS_PFSCP_ENABLE_SE051A_0001A920, "SSS_PFSCP_ENABLE_SE051A_0001A920"),
    (KEYS_SSS_PFSCP_ENABLE_SE050E_0001A921, "SSS_PFSCP_ENABLE_SE050E_0001A921"),
    (KEYS_SSS_PFSCP_ENABLE_SE051W_0005A739, "SSS_PFSCP_ENABLE_SE051W_0005A739"),
    (KEYS_SSS_PFSCP_ENABLE_A5000_0004A736, "SSS_PFSCP_ENABLE_A5000_0004A736"),
    (KEYS_SSS_PFSCP_ENABLE_SE050F2_0001A92A, "SSS_PFSCP_ENABLE_SE050F2_0001A92A"),
    (KEYS_SSS_PFSCP_ENABLE_OTHER, "SSS_PFSCP_ENABLE_OTHER"),
)
...
SCP_DEFAULT_CONFIG="""#if defined(SSS_HAVE_SE05X_VER_03_XX) && SSS_HAVE_SE05X_VER_03_XX == 1
...
class SCPDefineKeys(object):
    ...
    def _write_key(self, key):
        self.o_file.write("    {")
        for val in key:
            self.o_file.write(" 0x%02X,"%(val))
        self.o_file.write(" }\n")

    def _write_oef(self, keys, oef_name):
        enc = keys[0]
        mac = keys[1]
        rmac = keys[2]
        self.o_file.write("\n// {}\n".format(oef_name))
        self.o_file.write("#if defined ({}) && {} == 1\n".format(oef_name, oef_name))
        self.o_file.write("#define SSS_AUTH_KEY_ENC \\\n")
        self._write_key(enc)
        self.o_file.write("#define SSS_AUTH_KEY_MAC \\\n")
        self._write_key(mac)
        self.o_file.write("#define SSS_AUTH_KEY_DEK \\\n")
        self._write_key(rmac)
        self.o_file.write("#endif // {}\n".format(oef_name))

    def write_all_oefs(self):
        for oef in LIST_ALL_OEFS:
            self._write_oef(oef[0], oef[1])

    def write_default_configurations(self):
        self.o_file.write("#error \"Move these defines to fsl_sss_ftr.h\"")
        self.o_file.write("""
/* Enable one of these 
 ...
 */""")
        list_oefs_str=[]
        for oef in LIST_ALL_OEFS:
            list_oefs_str.append(oef[1])

        for oef in list_oefs_str:
            self.o_file.write("\n#define {} 0".format(oef))

        # Check if at least one config is selected
        self.o_file.write("\n\n#if (( \\\n")
        for oef in list_oefs_str:
            self.o_file.write("     {} + \\\n".format(oef))
        self.o_file.write("     0) == 0) \n")
        self.o_file.write(SCP_DEFAULT_CONFIG)
        self.o_file.write("\n#endif\n")

        # Check if more than one configs are selected
        self.o_file.write("\n#if (( \\\n")
        for oef in list_oefs_str:
            self.o_file.write("     {} + \\\n".format(oef))
        self.o_file.write("     0) > 1) \n")
        self.o_file.write("#error \"Select only one Platform SCP configuration\"")
        self.o_file.write("\n#endif\n")
...
def main():
    ...
    scp.write_default_configurations()
    scp.write_all_oefs()
